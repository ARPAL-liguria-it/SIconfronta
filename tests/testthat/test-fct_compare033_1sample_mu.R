...
test_that("Calculations are correct for t-test on one sample and alternative = different", {
  ...
  expect_equal(ttest_result1$difference[[1]], "9.160")
  expect_equal(ttest_result1$difference[[2]], "11.84")
  expect_equal(ttest_result1$difference[[3]], "29.84")
...
test_that("Calculations are correct for t-test on one sample and alternative = greater", {
  ...
  expect_equal(ttest_result2$difference[[1]], "9.160")
  expect_equal(ttest_result2$difference[[2]], "-Inf")
  expect_equal(ttest_result2$difference[[3]], "27.75")
...
test_that("Calculations are correct for t-test on one sample and confidence = 0.99", {
  ...
  expect_equal(ttest_result3$difference[[1]], "9.160")
  expect_equal(ttest_result3$difference[[2]], "5.921")
  expect_equal(ttest_result3$difference[[3]], "35.76")
