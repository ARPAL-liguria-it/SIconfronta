...
```{r dataresults, echo=FALSE, results="asis", out.width='250px', fig.pos="p", fig.align="center", fig.cap=paste0(sprintf("\\label{%s}", ordered_analytes), "Boxplot per l'analita ", ordered_analytes, ".")}
